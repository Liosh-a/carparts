    ...
    public class FilterSeeder
    {
        public static void SeedFilters(EFDbContext context)
        {
            ...
            string[] filterNames = { "Сторона", "Цвет", "Расположение", "Сторона Установки",
                    "Тип Запчасти","Сторона Установки","Месторасположение","Секция / часть","Поверхность","Наличие отверстий / прорезей","Код комплектации автомобиля","Особенности исполнения","Месторасположение",
                    "Секция / часть","Сторона установки","Сторона установки","Сторона установки","Сторона установки","Сторона установки","Регулировка","Тип стекла",
                    "Обогрев","Функции","Разрешение [пикселей]","Угол обзора","Сторона установки","Тип изделия","Расположение","Код комплектации автомобиля",
                    "Сторона установки","Тип изделия","Сторона установки","Число дверей","Материал изготовления","Сторона установки","Материал изготовления","Поверхность",
                    "Сторона установки","Тип осветительного прибора","Автомобиль с лево- / правосторонним расположением руля","Цвет","Цвет стекла фары","Тип ламп","Цвет кожуха","Форма",
                    "Ограничение производителя","Конструкция рассеивателя","Спецификация","Тип","Цвет","Тип ленты",
            };
